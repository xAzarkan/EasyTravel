...
public class WeatherActivity extends AppCompatActivity {
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(TodayWeatherFragment.getInstance(), "Current Weather");
        adapter.addFragment(ForecastFragment.getInstance(), "Forecasts");
        adapter.addFragment(PopularCitiesFragment.getInstance(), "Popular cities");
